const IconThemeManager = {
    customIcons: {
        home: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="file-icon-svg"><path fill="var(--icon-folder)" d="M575.8 255.5c0 18-15 32.1-32 32.1h-32v144c0 44.2-35.8 80-80 80H144c-44.2 0-80-35.8-80-80v-144H32.2c-17 0-32-14.1-32-32.1c0-9 3.5-17.1 9-23.1L257 9.1c12-12 32-12 44 0L566.8 232.4c6 6 9 14.1 9 23.1zM384 448V320H192v128h192z"/></svg>`,
    ...
    getIcon(name, isDir) {
        ...
        if (['cpp', 'cc', 'cxx'].includes(ext)) return this.customIcons.cpp;
